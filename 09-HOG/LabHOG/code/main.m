...
num_negative_examples = 100; %Higher will work strictly better, but you should start with 10000 for debugging
...
% ASUMI QUE LAMBA ERA LO MISMO QUE 'C' ENTONCES ESTO TOCA CAMBIARLO DE A POCOS
LAMBDA = 10;
train_features=[features_pos;features_neg]';
train_labels=[ones(size(features_pos,1),1);-1*ones(size(features_neg,1),1)]';
[w,b] = vl_svmtrain(train_features,train_labels,LAMBDA);
